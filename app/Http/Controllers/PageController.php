...
//dd($all_data);
  ...
  $allpoints=($getUser->userpricin );
        ...
        if($getUser->userpricin->current_points >= 0 ){
         ...
         $FawryPayment_data = FawryPayment::where('user_id',$getUser->id)-> get();
...
//echo($authToken);
         ...
         return view('user_point_count_history',compact('FawryPayment_data','all_data','points','all_history_of_point_of_user'));
    }
