...
class RequestPhotoSessionController extends AppBaseController
{
    ...
    public function edit($id)
    {
        ...
        $users = User::pluck('name', 'id');
        $activity_logs = Activity::forSubject($requestPhotoSession)->orderBy('id','DESC')->paginate(10);


        return view('request_photo_sessions.edit',compact('users','activity_logs'))->with('requestPhotoSession', $requestPhotoSession);
    }
