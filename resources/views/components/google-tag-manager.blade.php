...
})(window,document,'script','dataLayer','GTM-MXSN7S5R');
</script>
<!-- End Google Tag Manager -->
<!-- Google tag (gtag.js) -->

<script async src="https://www.googletagmanager.com/gtag/js?id=G-W2S6MH520N"></script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-W2S6MH520N');
</script>
...
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MXSN7S5R"
