                    ...
                    <div style="text-align: center;" class="call-to-act-head">
                        ...
                        <h3 class="headingTitle2">
                            ...
                            <p class="mt-3">
                                ...
                                رايت تشويز توفر لك فريق احترافي مع أفضل معدات الإضاءة والتصوير، لإظهار عقارك في أبهى
                                صورة

                            </p>

                            <a style="text-align: center" class="btn btn-call-to-act mt-3"
                               id="trigger-3">{{ trans('langsite.subscribe_nw')}}</a>
                    </div>
            ...
            <form>
                <div class="row">
                    ...
                    <div class="col form-group">
                        <input type="text" name="user_session_phone" class="form-control" id="phone"
                               placeholder="الهاتف"
                               required @if(Auth::check()) value="{{ Auth::user()->MOP }}"
                    ...
                    <div class="col form-group">
                        <input type="text" name="user_session_name" class="form-control" id="name" placeholder="الاسم"
                               required @if(Auth::check()) value="{{ Auth::user()->name }}"
                               @else value="{{ old('user_name') }}" @endif>
                        @error('user_name')
                        <p class="text-danger text-sm mt-1"> {{ $message }} </p>
                        @enderror
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="user_session_address" id="subject"
                    ...
                    <div class="form-group">
    							 <textarea class="form-control" name="session_description" rows="5"
                                           placeholder="تفاصيل العقار المطلوب تصويره"
