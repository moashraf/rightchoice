...
@endsection
    ...
    <div   class="  text-center">
        <div style="height: 100%;">
            ...
            <span>{{   $PriceVip->nam }}</span>
            <br> <br>
            <h1 style="display: inline; font-weight:bold;" class="pr-value   ">{{ $PriceVip->price }}</h1><span>ج.م</span>
            <br>
                <p> {{  $PriceVip->name }} </p>
                 <br>
                ...
                <div class="tab-pane fade" id="pills-fawry" role="tabpanel" aria-labelledby="pills-fawry-tab">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input  TYPE="hidden" NAME="price" value="{{$PriceVip->price}}">
                           ...
                           <!-- <input  TYPE="hidden" NAME="currency_code" value="CurrencyCode">
                            ...
                            <input  TYPE="hidden" NAME="pricePoints" value="">
...
function buildChargeRequest() {
	const chargeRequest = {
		...
		customerMobile: '01033077223',
		customerEmail: 'ialyzaafan@gmail.com',
		customerName: '',
		paymentExpiry: '1672351200000',
		customerProfileId: <?php  $numsort=55555;  echo $PriceVip->id.$numsort. $aqarSingle_id; ?>, // in case merchant has customer profiling then can send profile id to attach it with order as reference 
		chargeItems: [
			{
				itemId: '23432',
		...
		paymentMethod: 'CARD',
		returnUrl: 'https://rightchoice-co.com/ar/tmyezz_fawryCallback',
