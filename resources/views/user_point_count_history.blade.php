...
تاريخ الاشتراق في الباقه :
	<?php  $newDate = date("d-m-Y", strtotime( $not->created_at )); echo $newDate ;?>  
                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-sm-5 col-card-imgs">
                                                <div class="click">
                                                        ...
                                                        <div><a href="{{ URL::to(Config::get('app.locale').'/aqars/' . $val->all_aqat_viw ->slug) }}" target="_blank">
                                                    ...
                                                    <div class="listing-detail-wrapper">
                                                        <div class="listing-short-detail-wrap flex-block">
                                                            <div class="listing-short-detail">
                                                                <h4  class="listing-name verified"><a href="{{ URL::to(Config::get('app.locale').'/aqars/' . $val->all_aqat_viw->slug) }}" target="_blank">
                                                                ...
                                                                <!-- <h4 class="listing-name verified"><a href="single-property-1.html" class="prt-link-detail">Banyon Tree Realty</a></h4> -->
                                                                    ...
                                                                    <div>
                                                                      ...
                                                                      <a  href="#" class="btn btn-outline-warning">عدد النقاط التي تم خصمها : {{ $val->all_aqat_viw ->points_avail  }}</a>
                                                    ...
                                                    <div class="list-rap">
                                                        <div class="list-fx-features2" >
                                                            <div class="listing-card-info-icon">
                                                                                                      تاريخ مشاهده العقار : 
                               <?php  $newDate = date("d-m-Y", strtotime(  $val->created_at)); echo $newDate ;?>  
											...
											<div class="foot-location">
										     @if ($val->all_aqat_viw->governrateq)
                                                        ...
                                                        <a class="btn btn-light  ml-2 addToCart" data-id="{{$val->all_aqat_viw['id']}}"> حفظ <svg
                                                        ...
                                                        <a  href="{{ URL::to(Config::get('app.locale').'/aqars/' . $val->all_aqat_viw->slug) }}" id="btn1" class="btn" target="_blank">عرض</a>
