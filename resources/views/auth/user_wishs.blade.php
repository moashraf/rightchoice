                                            ...
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-sm-5 col-card-imgs">
                                                    <div class="click">
                                                        ...
                                                        <div>
                                                            <a href="{{ URL::to(Config::get('app.locale').'/aqars/' . $aqar->aqarInfo->slug) }}">
                                                                ...
                                                                @else
                                                                    ...
                                                                    @else
                                                                        <img
                                                                            src="https://rightchoice-co.com/images/FBO.png"
                                                                            class="img-fluid main-img" alt="main">
                                                                    @endif
                                                                @endif
                                                            </a></div>
                                                ...
                                                <div class="col-sm-7 order-lg-first col-card-details">
                                                    <div class="card-body">
                                                            ...
                                                            <div class="listing-short-detail-wrap">
                                                                <div class="listing-short-detail">
                                                                    ...
                                                                    <h4 class="listing-name verified"><a
                                                                            href="{{ URL::to(Config::get('app.locale').'/aqars/' . $aqar->aqarInfo->slug) }}">
                                                        ...
                                                        <div class="btnAdds listing-detail-footer"
                                                            ...
                                                            <div>
                                                                <a href="#" type="button"
                                                                   class="btn btn-danger  ml-2 removeFromCart"
                                                                   data-id="{{$aqar['id']}}"> الغاء
                                                                    <svg
