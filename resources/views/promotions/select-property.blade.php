<x-layout>
                ...
                @else
                    ...
                    >
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 mb-4 d-flex">
                                    <label class="rc-property-card">
                                        ...
                                        <span class="rc-property-card__body">
                                            ...
                                            <span class="rc-property-card__select-text">
                        ...
                        <div class="rc-property-picker__submit">
                            ...
                            <button type="submit" class="rc-property-picker__primary-btn">
    ...
    <style>
        ...
        .rc-property-card { position: relative; overflow: hidden; width: 100%; display: flex; flex-direction: column; margin: 0; border: 2px solid transparent; border-radius: 24px; background: #fff; box-shadow: 0 16px 42px rgba(5,55,91,.08); cursor: pointer; transition: transform .22s ease, border-color .22s ease, box-shadow .22s ease; }
        .rc-property-card:hover { transform: translateY(-5px); box-shadow: 0 23px 52px rgba(5,55,91,.13); }
        .rc-property-card:has(input:checked) { border-color: var(--picker-green); box-shadow: 0 23px 55px rgba(24,199,161,.18); }
        ...
        .rc-property-card input:checked ~ .rc-property-card__check { color: #fff; border-color: var(--picker-green); background: var(--picker-green); }
        ...
        .rc-property-card input:checked ~ .rc-property-card__body .rc-property-card__select-text { color: #08765f; }
