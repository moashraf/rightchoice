    ...
    <section class="rc-buyer-hero">
        ...
        <div class="container rc-buyer-hero__inner">
            <div class="rc-buyer-hero__copy">
                ...
                <p>{{ $isEnglish ? 'Get points to unlock property contact details and communicate directly with owners—without broker commission.' : 'احصل على نقاط تفتح لك بيانات العقارات وتساعدك تتواصل مباشرة مع ملاك أكثر، بدون عمولة وسيط.' }}</p>
    ...
    <section class="rc-buyer-benefits">
        <div class="container">
            <header class="rc-buyer-heading">
                ...
                <h2>{{ $isEnglish ? 'Reach the right property faster' : 'وصل للعقار المناسب بشكل أسرع' }}</h2>
            </header>
