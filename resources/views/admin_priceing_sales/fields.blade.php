...
<div class="form-group col-sm-4">
    ...
    {!! Form::number('points', null, ['class' => 'form-control', 'min' => 1]) !!}
...
<!-- Title Color Field -->
<div class="form-group col-sm-4">
    {!! Form::label('title_color', 'Title Color:') !!} <span class="text-danger">*</span>
...
<!-- Bk Color Field -->
<div class="form-group col-sm-4">
    {!! Form::label('bk_color', 'Bk Color:') !!} <span class="text-danger">*</span>
...
<!-- Desc1 Field -->
<div class="form-group col-sm-6">
    {!! Form::label('desc1', 'Description One:') !!} <span class="text-danger">*</span>
    {!! Form::textarea('desc1', null, ['class' => 'form-control', 'rows' => 3]) !!}
    <small class="text-danger">{{ $errors->first('desc1') }}</small>
</div>

<!-- Desc2 Field -->
<div class="form-group col-sm-6">
    {!! Form::label('desc2', 'Description Two:') !!} <span class="text-danger">*</span>
    {!! Form::textarea('desc2', null, ['class' => 'form-control', 'rows' => 3]) !!}
    <small class="text-danger">{{ $errors->first('desc2') }}</small>
</div>

<!-- Desc3 Field -->
<div class="form-group col-sm-6">
    {!! Form::label('desc3', 'Description Three:') !!} <span class="text-danger">*</span>
    {!! Form::textarea('desc3', null, ['class' => 'form-control', 'rows' => 3]) !!}
