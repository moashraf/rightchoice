...
@section('content')
    <div class="container-fluid">
        ...
        @forelse($usersQuery as $user)
            @php
                $userSerial = ($usersQuery->firstItem() ?? 1) + $loop->index;
                ...
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap py-2"
                    ...
                    <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center justify-content-center ml-2"
                             title="رقم التسلسل"
                             style="min-width:34px;height:34px;border-radius:50%;background:#343a40;color:#fff;font-size:13px;font-weight:700;box-shadow:0 2px 6px rgba(0,0,0,.15);">
                            {{ $userSerial }}
                        </div>
