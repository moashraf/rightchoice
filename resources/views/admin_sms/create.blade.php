{{-- SMS Compose & Send Page --}}
@extends('layouts.admin')

@section('title', 'إرسال رسائل SMS')
...
@section('third_party_stylesheets')
    ...
    <style>
        ...
        .placeholder-tag:hover { background: #007bff; color: #fff; }
        .preview-box { background: #f4f6f9; border: 1px dashed #ccc; padding: 15px; border-radius: 5px; min-height: 60px; }
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-sms"></i> إرسال رسائل SMS</h1>
                </div>
                <div class="col-sm-6">
    ...
    <div class="content px-3">
        ...
        <form id="smsForm" action="{{ route('sitemanagement.sms.store') }}" method="POST">
            @csrf
                ...
                <div class="col-md-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea
                                    ...
                                    rows="5"
                                    maxlength="640"
                                    placeholder="اكتب نص الرسالة هنا... يمكنك استخدام {name} لإدراج اسم المستخدم"
                                    dir="rtl"
                                >{{ old('message_template') }}</textarea>
                                <small class="form-text text-muted">
                                    <span id="charCount">0</span> / 640 حرف
                                </small>
                            </div>
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            {{-- User Selection Panel (shown when "selected_users" is chosen) --}}
                    ...
                    <div class="card card-warning">
                        <div class="card-body text-center">
                            ...
                            <small class="form-text text-muted mt-2">
                                سيتم إرسال الرسائل في الخلفية. يمكنك متابعة الحالة من صفحة التقارير.
                            </small>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-warning">
                        <h5 class="modal-title"><i class="fas fa-exclamation-triangle"></i> تأكيد الإرسال</h5>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
                        <p>هل أنت متأكد من إرسال الرسائل؟</p>
                        ...
                        <div class="alert alert-info">
                            <strong>ملاحظة:</strong> سيتم إرسال الرسائل فقط للأرقام الصالحة.
                        </div>
                    </div>
...
$(function () {
    ...
    function loadUsers(page) {
        ...
        $.ajax({
            url: '{{ route("sitemanagement.sms.searchUsers") }}',
    ...
    function refreshPreview() {
        ...
        $.ajax({
            url: '{{ route("sitemanagement.sms.previewRecipients") }}',
            method: 'POST',
            data: data,
            success: function (r) {
    ...
    $('#sendBtn').on('click', function () {
        ...
        // Refresh preview and show confirmation modal
        var data = {
            _token: $('meta[name="csrf-token"]').attr('content'),
            send_type: sendType,
            user_ids: sendType === 'selected_users' ? selectedUserIds : []
    ...
    $('#confirmSendBtn').on('click', function () {
        ...
        if ($('input[name="send_type"]:checked').val() === 'selected_users') {
            selectedUserIds.forEach(function (id) {
                $('<input>').attr({ type: 'hidden', name: 'user_ids[]', value: id }).appendTo('#smsForm');
            });
        }
