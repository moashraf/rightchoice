...
<section id="inner-listing">
    <div class="container">
<x-adv />
		<h3>عقار للبيع - التجمع الخامس</h3>
					...
					<div class="sticky">
						...
						<div class="card">
							<div class="card-body">
								...
								<a href="#" class="btn btn-light"> حفظ <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
									<path d="M8 2.748l-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z"/>
								  </svg></a>
								<hr class="hr-add">
								  <p>اختر الباقة المناسبة لك</p>
								  <a class="btn btn-primary-light" href="{{ route('priceSeller', ['locale' => Config::get('app.locale')]) }}">باقات البائع</a>
								  <a class="btn btn-primary-light" href="{{ route('priceBuyer', ['locale' => Config::get('app.locale')]) }}">باقات المشتري</a>
			...
			<div class="col-lg-8">
				...
				<div class="details mt-3">
					<h3>اكثر التفاصيل</h3>
						<ul>
							<li>تقسيط</li>
							<li><strong>مقدم:</strong>100,000 EGP</li>
							<li><strong>مده القسط:</strong>5 سنين</li>
							<li><strong>قيمه القسط:</strong>5000 EGP</li>
						</ul>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore natus voluptatum, in saepe amet totam beatae! Optio, placeat eveniet odit molestiae rem beatae distinctio itaque rerum voluptatibus tenetur vitae asperiores.</p>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore natus voluptatum, in saepe amet totam beatae! Optio, placeat eveniet odit molestiae rem beatae distinctio itaque rerum voluptatibus tenetur vitae asperiores.</p>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore natus voluptatum, in saepe amet totam beatae! Optio, placeat eveniet odit molestiae rem beatae distinctio itaque rerum voluptatibus tenetur vitae asperiores.</p>
						<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore natus voluptatum, in saepe amet totam beatae! Optio, placeat eveniet odit molestiae rem beatae distinctio itaque rerum voluptatibus tenetur vitae asperiores.</p>
				</div>
